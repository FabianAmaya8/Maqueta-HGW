...
export function productosLista() {
    ...
    async function consulta() {
        ...
        lista(encabezado, productos_db, tabla, columna, posicion_id);
    }
    consulta();
}
export function crearLista(encabezado, valores, tabla, columna, posicion_id) {
    return lista(encabezado, valores, tabla, columna, posicion_id);
}
export function lista(encabezadoTabla, valoresFila, tabla, columna, posicion_id) {
    function encabezado() {
        let encabezadoHTML = "";
            ...
            datosVar += `
                <td>
                    <div class="group-btn">
                        ...
                        <button class="btn btn-danger btn-crud btn-eliminar" onclick="eliminarProducto(event, '${tabla}', '${columna}', '${posicion_id}')">
